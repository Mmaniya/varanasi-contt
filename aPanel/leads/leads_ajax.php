...
if ($action == 'add_edit_leads') {
    ...
    if (empty(trim($_POST['id']))) {
        ...
        $result = Table::insertData(array('tableName' => TBL_LEADS, 'fields' => $param, 'showSql' => 'N'));
...
if($action == 'remove_clients'){
    ...
    $where = array('id' => $_POST['id']);
    $result = Table::deleteData(array('tableName' => TBL_LEADS, 'fields' => $param, 'where' => $where, 'showSql' => 'N'));
