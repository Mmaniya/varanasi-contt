            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6">
                    ...
                    <div class="input-group input-group-inverse">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Category Name" name="category_name" value="<?php echo $category_name; ?>">
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6">
                    ...
                    <div class="input-group input-group-inverse">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Category Abbreviation" name="category_abbr" value="<?php echo $category_abbr; ?>" >
                    </div>
                </div>
            </div>
    ...
    <div class="card borderless-card">
        <div class="card-block warning-breadcrumb">
            ...
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    <li class="breadcrumb-item"><a href="<?php echo CATEGORY_DIR ?>/index.php"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>               
                </ul>
            </div>       
        </div>
    </div>
                                    ...
                                    <input type="hidden"  name="admin_id" value="<?php echo $_SESSION['admin_id']; ?>">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3 col-lg-3">
                                                    ...
                                                    <div class="input-group input-group-inverse">
                                                        <select  class="form-control" name="service_payment_type" onchange="service_payment(this.value)">
                                        ...
                                        <fieldset>              
                                                        ...
                                                        <div class="row" id="appeded_column"> 
                                                            <?php 
                                                                ...
                                                                if(count($rsServiceFeatures)>0){  ?>
                                                                    <script> z=0;    </script>
                                                                <?php  
                                                                    foreach ($rsServiceFeatures as $key => $value){  $rand = rand(); ?>
                                                ...
                                                <script>
                                                    ...
                                                    function removeEditRow(id) { if(z==1) { return;  } z--;	 $('#edit_column_'+id).remove();  }      
                                                </script>             
                                        </fieldset>
                                        <h3> Faq </h3>
                                        <fieldset>
                                        ...
                                        <div class="card-block">
                                            ...
                                            <script>
                                                tinymce.init({ selector: 'myeditable'})
                                                i=1;
