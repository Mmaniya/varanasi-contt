        ...
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <input type="hidden" value="<?php echo $_POST['user_id']; ?>" name="id">
                    ...
                    <div class="col-md-6">
                        <div class="form-group"> 			 
                            <input type="email" class="form-control" id="email" placeholder="Email" name="email" autocomplete="off" value="<?php echo $email;?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <select name="user_type" id="user_type" class="form-control">
                                ...
                                <!-- <option value="SA" <?php if($user_type=='SA') { echo 'selected'; }?>>Super Admin</option> -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group"> 			 
                            <input type="password" class="form-control" id="password" name="pass" placeholder="Password" autocomplete="off" value="<?php echo $password; ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group"> 			 
                            <input type="password" class="form-control" id="cpassword" name="cpass" placeholder="Confirm Password" autocomplete="off" value="<?php echo $password; ?>">
                        </div>
                    </div>
                    </div>
