               ...
               <div class="table-responsive">
                  ...
                  <table class="table table-bordered">
                     ...
                     <tbody  id="draggableMultiple">
                        ...
                        <tr class="row_id_<?php echo $value->id; ?> sortable-moves" id="<?php echo $value->id; ?>">
                           <input type="hidden" name="category_id[]" value="<?php echo $value->id ?>">
                           <th><?php echo $key + 1 ?></th>
                           <td><?php echo $value->category_name ?></td>
                           <td>
                              <!-- <div class="btn-group " role="group"> -->
                                 <a href="javascript:void(0);" class="btn btn-sm btn-info" onclick="add_edit_category(<?php echo $value->id; ?>)"><i class="fa fa-edit"></i> Edit</a>
